...
public class MovieCrudSeleniumIT {
    ...
    static Long sharedEditId;   // Track the primary key of the entity generated
...
//        driver = new FirefoxDriver();
    ...
    void shouldCreateMovie(String title, String genre, String rating, String price, String releaseDate) {
    ...
    @ParameterizedTest
    @CsvSource({
            "Java 19 Release Party,Action,G,9.20,'2021-09-21'",
    })
