...
//
	@DataSourceDefinition(
		...
		className="com.microsoft.sqlserver.jdbc.SQLServerDataSource",
		url="jdbc:sqlserver://DMIT-Capstone1.ad.sast.ca;databaseName=DMIT2015_1221_A01_swuUser2015;TrustServerCertificate=true", // replace yourNaitUsername
		user="swuUser2015",	// replace yourNaitUsername
